...
const products: Product[] = [
  ...
  },
  {
    ...
    siteUrl: 'https://talentsy.ru/kouching',
    shortDescription: 'Обучение коучингу — от основ до профессиональной практики с реальными клиентами',
  },
  {
    id: 'crisis-counseling',
    name: 'Кризисное консультирование',
    tags: ['повышение_квалификации'],
    category: 'Психология',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/krizisnoe-konsultirovanie',
    shortDescription: 'Специализация для психологов по работе с клиентами в кризисных состояниях',
  },
  {
    id: 'orkt',
    name: 'ОРКТ',
    ...
    category: 'Психология',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/orkt',
    shortDescription: 'Ориентированная на решение краткосрочная терапия — практический подход к быстрым результатам',
  },
  {
    id: 'personal-therapy',
    name: 'Обучающая личная терапия',
    tags: ['повышение_квалификации'],
    category: 'Психология',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/obuchayushchaya-lichnaya-terapiya',
    shortDescription: 'Программа личной терапии для начинающих и практикующих психологов',
  },
  {
    id: 'pdzhk',
    name: 'ПДЖК',
    ...
    category: 'Психология',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/pdzhk',
    shortDescription: 'Психодинамика жизненного цикла — углублённая программа для практикующих специалистов',
  },
  {
    id: 'fashion-designer',
    name: 'Профессия "Дизайнер одежды"',
    tags: ['для_профессии'],
    category: 'Дизайн',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/dizajner-odezhdy',
    shortDescription: 'Комплексная программа обучения дизайну одежды — от эскизов до создания коллекции',
  },
  {
    id: 'nutritionist',
    name: 'Профессия "Интегративный нутрициолог"',
    tags: ['для_профессии'],
    category: 'Здоровье',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/nutriciolog',
    shortDescription: 'Обучение профессии нутрициолога с интегративным подходом к питанию и здоровью',
  },
  {
    id: 'supervision',
    name: 'Супервизия',
    ...
    category: 'Психология',
    updatedAt: '31.03.2026',
    siteUrl: 'https://talentsy.ru/superviziya',
    shortDescription: 'Программа супервизии для практикующих психологов — профессиональный рост и поддержка',
  },
]
