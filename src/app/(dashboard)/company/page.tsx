...
const sections: SectionCard[] = [
  {
    ...
    description: 'Организационная структура, подразделения и иерархия',
  ...
  },
  {
    ...
    description: 'Миссия компании, видение, ценности и стратегия развития',
    icon: <Target size={32} />,
  ...
  },
  {
    ...
    description: 'Обучающие материалы и видео для новых сотрудников',
